# ============================================================================
# IAQ AUDIT - PRODUCTION DOCKERFILE
# ============================================================================
...
ARG NEXT_PUBLIC_EMAILJS_RESULTS_TEMPLATE_ID
ARG NEXT_PUBLIC_EMAILJS_RECOVERY_TEMPLATE_ID
...
ENV NEXT_PUBLIC_EMAILJS_RESULTS_TEMPLATE_ID=$NEXT_PUBLIC_EMAILJS_RESULTS_TEMPLATE_ID
ENV NEXT_PUBLIC_EMAILJS_RECOVERY_TEMPLATE_ID=$NEXT_PUBLIC_EMAILJS_RECOVERY_TEMPLATE_ID
