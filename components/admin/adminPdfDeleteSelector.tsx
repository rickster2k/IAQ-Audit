...
export default function PdfDeleteSelectorModal({  submissionId,  currentPdfName,  onClose}: PdfSelectionModalProps) {
    ...
    return (
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
            <div className="bg-white rounded-lg p-6 max-w-2xl w-full mx-4 max-h-[80vh] overflow-hidden flex flex-col">
                ...
                <h2 className="text-xl font-semibold">Delete Premium PDF (Can not select pdf that is assigned to a User)</h2>
                <button
                    onClick={onClose}
                ...
                <div className="flex-1 overflow-y-auto">
                    ...
                    {pdfs.map((pdf) => {
                        ...
                        <div
                            ...
                            onClick={() => !isDisabled && setSelectedPdf(pdf)}
                        >
                            ...
                            <div className="flex-1">
                                ...
                                <input
                                    type="radio"
                                    checked={selectedPdf?.url === pdf.url}
                                    onChange={() => !isDisabled && setSelectedPdf(pdf)}
                                    disabled={isDisabled}
                            ...
                            <button
                                ...
                                className="text-blue-600 hover:underline text-sm ml-4 absolute top-2 right-4"
                            >
                                Preview
                            </button>
                ...
                >
                    {saving ? 'Deleting...' : 'Delete Selected PDF'}
                </button>
                </div>
            </div>
        </div>
